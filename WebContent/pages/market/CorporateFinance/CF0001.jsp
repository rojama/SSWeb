...
<body>
    ...
    <script type="text/javascript">
        var panels = [
            {id:'p1',title:'USD_CNY',height:150,collapsible:true,cache:false,closable:true,href:'CF0002.jsp?Currency=USD_CNY'},
            {id:'p2',title:'USD_AUD',height:150,collapsible:true,cache:false,closable:true,href:'CF0002.jsp?Currency=USD_AUD'},
            {id:'p3',title:'USD_EUR',height:150,collapsible:true,cache:false,closable:true,href:'CF0002.jsp?Currency=USD_EUR'},
            {id:'p4',title:'USD_CHF',height:150,collapsible:true,cache:false,closable:true,href:'CF0002.jsp?Currency=USD_CHF'},
            {id:'p5',title:'USD_HKD',height:150,collapsible:true,cache:false,closable:true,href:'CF0002.jsp?Currency=USD_HKD'},
            {id:'p6',title:'CNY_HKD',height:150,collapsible:true,cache:false,closable:true,href:'CF0002.jsp?Currency=CNY_HKD'},
        ];

...
<%
	...
	String TableName = "TR_COM_BR_FXSPREAD";  //数据库表名
...
$(function ()
		{        	
			...
			$grid = $("#maingrid").ligerGrid({
		        ...
		        columns: [  //主表的标题栏位定义
		                    { display: '机构ID', name: 'TT_UNITID', type:"text" },
		        			{ display: '货币的', name: 'TT_CURRENCYPAIR',type:"text"},
		        			{ display: '交易类型', name: 'TT_DEALTYPE',type:"text"},
		        		    ...
		        		    { display: '币种中文名称', name: 'TT_BIDPERCENT',type:"text"}
		...
		function toolbarAction(item)
		{
			...
			if (action == "add"){  //新增数据
				$form.setData({TT_UNITID:'',TT_CURRENCYPAIR:'',TT_DEALTYPE:'',TT_DEALTENOR:'',
					TT_BIDPOINT:'',TT_OFFERPOINT:'',TT_MAINTANCEUSER:'',TT_MAINTANCEDATE:'',TT_BIDPERCENT:''}); 
				...
				$form.setEnabled(['TT_UNITID','TT_CURRENCYPAIR','TT_DEALTYPE','TT_DEALTENOR',
				                  'TT_BIDPOINT','TT_OFFERPOINT','TT_MAINTANCEUSER','TT_MAINTANCEDATE','TT_MAINTANCEDATE'],true);
				...
				$form.setData({TT_MAINTANCEUSER:'<%=LoginUserID%>',TT_MAINTANCEDATE:'<%=Systemdate%>'}); 
				$form.setEnabled(['TT_UNITID','TT_CURRENCYPAIR','TT_DEALTYPE','TT_DEALTENOR',
				                  'TT_BIDPOINT','TT_OFFERPOINT','TT_MAINTANCEUSER','TT_MAINTANCEDATE','TT_MAINTANCEDATE'],false);

...
<%
	...
	String TableName = "TR_COM_BIZ_CtryInfo";  //数据库表名
		...
		{        	
			...
			$grid = $("#maingrid").ligerGrid({
		        ...
		        columns: [  //主表的标题栏位定义
		        			...
		        			{ display: '国家名称', name: 'TR_CTRYNAME', minWidth: 80 },
		        			{ display: '国家英文名称', name: 'CTRYENGNAME', minWidth: 80 },
		        			{ display: '国际电话代码', name: 'TR_NATIONALTELCODE', minWidth: 80 },
		        			{ display: '交割前置日数', name: 'TR_VALUEDAYS', minWidth: 80 },
		        			{ display: '时差', name: 'TR_TIMEDIFF', minWidth: 80 },
		        			{ display: '国家等级代码', name: 'TR_CTRYLVLCODE', minWidth: 80 },
		        			{ display: '录入数据', name: 'MAINTAINDATE', minWidth: 80 },

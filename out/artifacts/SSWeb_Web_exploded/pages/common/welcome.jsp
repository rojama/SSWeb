...
<body style="padding:10px; overflow:auto; text-align:center;background:#FFFFFF;"> 
        ...
        <b><span id="labelusername"><%=shiro_session.getAttribute("USER_NAME") %></span><span> 您好，</span><span id="labelwelcome"></span><span>欢迎登录 <fmt:message key="sys_title"/></span></b>
        ...
        <div class="navbar-inner"> 
        <b><fmt:message key="sys_title"/>帮助</b> 
        </div>
        </div>

         <div id="guides">
	     <ul>
	     <li><span>访问<a href="http://www.xxxx.com.cn/" target="_blank"><fmt:message key="sys_title"/>主页</a>，获取最新资讯与信息</span></li>
	     <br/>
	     <li><span>如何使用<fmt:message key="sys_title"/>，查看<a href="" target="_blank">在线使用指南</a></span></li>
	     <br/>
	     <li><span>提交BUG或改进意义，请访问<a href="" target="_blank">BUG提交</a></span></li>
	     </ul>
	   </div>
